...
class bms{
    ...
    public: // data abstraction
        ...
        void about(){
            ...
            design(25, 177);
            gotoxy(14, 9);
            cout<<"It is a Simple Bank Management System Project for our 2nd Semester based on C++ programming language OOPs.";
                    gotoxy(45, 12);
                    cout<<"Members of our Team: ";
                    gotoxy(28, 13);
                    design(65, 205);
                    gotoxy(48, 15);
                    cout<<"[1] . Muhammad Arsal-2022350 ";
                    gotoxy(48, 16);
                    cout<<"[2] . Wardah Haya-2022622";
                    gotoxy(41, 21);
                    design(42, 196);
                    gotoxy(42,24);
